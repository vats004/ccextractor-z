...
impl Default for ISDBPos {
    fn default() -> Self {
        Self { x: 0, y: 0 }
    }
}

impl Default for IsdbCCComposition {
    fn default() -> Self {
        IsdbCCComposition::None
    }
}
